...
In addition, the package page under `help("collapse-package")` provides some more general information about the package and its design philosophy, as well as a very compact set of examples covering important functionality. 
