...
test_that("fvar performs like base::var", {
  ...
  expect_equal(fvar(NA, na.rm = FALSE), var(NA))
  expect_equal(fvar(1), var(1, na.rm = TRUE))
  expect_equal(fvar(1:3), var(1:3, na.rm = TRUE))
  expect_equal(fvar(-1:1), var(-1:1, na.rm = TRUE))
  expect_equal(fvar(1, na.rm = FALSE), var(1))
  expect_equal(fvar(1:3, na.rm = FALSE), var(1:3))
  expect_equal(fvar(-1:1, na.rm = FALSE), var(-1:1))
  expect_equal(fvar(x), var(x, na.rm = TRUE))
  expect_equal(fvar(x, na.rm = FALSE), var(x))
  expect_equal(fvar(xNA, na.rm = FALSE), var(xNA))
  expect_equal(fvar(xNA), var(xNA, na.rm = TRUE))
  expect_equal(fvar(mtcars), fvar(m))
  expect_equal(fvar(m), dapply(m, var, na.rm = TRUE))
  ...
  expect_equal(fvar(xNA, f), BY(xNA, f, var, na.rm = TRUE))
  expect_equal(fvar(m, g), BY(m, g, var, na.rm = TRUE))
  expect_equal(fvar(m, g, na.rm = FALSE), BY(m, g, var))
  expect_equal(fvar(mNA, g, na.rm = FALSE), BY(mNA, g, var))
  expect_equal(fvar(mNA, g), BY(mNA, g, var, na.rm = TRUE))
  expect_equal(fvar(mtcars, g), BY(mtcars, g, var, na.rm = TRUE))
  expect_equal(fvar(mtcars, g, na.rm = FALSE), BY(mtcars, g, var))
  expect_equal(fvar(mtcNA, g, na.rm = FALSE), BY(mtcNA, g, var))
  expect_equal(fvar(mtcNA, g), BY(mtcNA, g, var, na.rm = TRUE))
})
...
test_that("fvar with direct algorithm performs like base::var", {
  expect_equal(fvar(NA, stable.algo = FALSE), var(NA))
  expect_equal(fvar(NA, na.rm = FALSE, stable.algo = FALSE), var(NA))
  expect_equal(fvar(1, stable.algo = FALSE), var(1, na.rm = TRUE))
  expect_equal(fvar(1:3, stable.algo = FALSE), var(1:3, na.rm = TRUE))
  expect_equal(fvar(-1:1, stable.algo = FALSE), var(-1:1, na.rm = TRUE))
  expect_equal(fvar(1, na.rm = FALSE, stable.algo = FALSE), var(1))
  expect_equal(fvar(1:3, na.rm = FALSE, stable.algo = FALSE), var(1:3))
  expect_equal(fvar(-1:1, na.rm = FALSE, stable.algo = FALSE), var(-1:1))
  expect_equal(fvar(x, stable.algo = FALSE), var(x, na.rm = TRUE))
  expect_equal(fvar(x, na.rm = FALSE, stable.algo = FALSE), var(x))
  expect_equal(fvar(xNA, na.rm = FALSE, stable.algo = FALSE), var(xNA))
  expect_equal(fvar(xNA, stable.algo = FALSE), var(xNA, na.rm = TRUE))
  expect_equal(fvar(mtcars, stable.algo = FALSE), fvar(m))
  expect_equal(fvar(m, stable.algo = FALSE), dapply(m, var, na.rm = TRUE))
...
test_that("fsd performs like base::sd", {
  expect_equal(fsd(NA), sd(NA))
  expect_equal(fsd(NA, na.rm = FALSE), sd(NA))
  expect_equal(fsd(1), sd(1, na.rm = TRUE))
  expect_equal(fsd(1:3), sd(1:3, na.rm = TRUE))
  expect_equal(fsd(-1:1), sd(-1:1, na.rm = TRUE))
  expect_equal(fsd(1, na.rm = FALSE), sd(1))
  expect_equal(fsd(1:3, na.rm = FALSE), sd(1:3))
  expect_equal(fsd(-1:1, na.rm = FALSE), sd(-1:1))
  expect_equal(fsd(x), sd(x, na.rm = TRUE))
  expect_equal(fsd(x, na.rm = FALSE), sd(x))
  expect_equal(fsd(xNA, na.rm = FALSE), sd(xNA))
  expect_equal(fsd(xNA), sd(xNA, na.rm = TRUE))
  expect_equal(fsd(mtcars), fsd(m))
  expect_equal(fsd(m), dapply(m, sd, na.rm = TRUE))
  ...
  expect_equal(fsd(xNA, f), BY(xNA, f, sd, na.rm = TRUE))
  expect_equal(fsd(m, g), BY(m, g, sd, na.rm = TRUE))
  expect_equal(fsd(m, g, na.rm = FALSE), BY(m, g, sd))
  expect_equal(fsd(mNA, g, na.rm = FALSE), BY(mNA, g, sd))
  expect_equal(fsd(mNA, g), BY(mNA, g, sd, na.rm = TRUE))
  expect_equal(fsd(mtcars, g), BY(mtcars, g, sd, na.rm = TRUE))
  expect_equal(fsd(mtcars, g, na.rm = FALSE), BY(mtcars, g, sd))
  expect_equal(fsd(mtcNA, g, na.rm = FALSE), BY(mtcNA, g, sd))
  expect_equal(fsd(mtcNA, g), BY(mtcNA, g, sd, na.rm = TRUE))
})
