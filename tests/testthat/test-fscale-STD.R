...
test_that("Unweighted customized scaling works as intended", {
  expect_equal(su(fscale(x, mean = 5.142, sd = 3.999)), c(5.142, 3.999))
  expect_equal(su(fscale(x, mean = 5.142, sd = 3.999, na.rm = FALSE)), c(5.142, 3.999))
  expect_equal(su(fscale(xNA, mean = 5.142, sd = 3.999, na.rm = FALSE)), c(NaN, NA))
  expect_equal(su(fscale(xNA, mean = 5.142, sd = 3.999)), c(5.142, 3.999))
  expect_equal(qM(fscale(mtcars, mean = 5.142, sd = 3.999)), fscale(m, mean = 5.142, sd = 3.999))
  expect_equal(su(fscale(m, mean = 5.142, sd = 3.999)), rep(c(5.142, 3.999), c(11, 11)))
  expect_equal(su(fscale(m, mean = 5.142, sd = 3.999, na.rm = FALSE)), rep(c(5.142, 3.999), c(11, 11)))
  expect_equal(su(fscale(mNA, mean = 5.142, sd = 3.999, na.rm = FALSE)), rep(c(5.142, 3.999), c(11, 11))+miss)
  expect_equal(su(fscale(mNA, mean = 5.142, sd = 3.999)), rep(c(5.142, 3.999), c(11, 11)))
  expect_equal(suby(fscale(x, f, mean = 5.142, sd = 3.999), f), rep(c(5.142, 3.999), rep(fnlevels(f), 2)))
  expect_equal(suby(fscale(x, f, mean = 5.142, sd = 3.999, na.rm = FALSE), f), rep(c(5.142, 3.999), rep(fnlevels(f), 2)))
  expect_equal(suby(fscale(xNA, f, mean = 5.142, sd = 3.999), f), rep(c(5.142, 3.999), rep(fnlevels(f), 2)))
})

test_that("Unweighted customized scaling works like bscale (defined above)", {
  expect_equal(fscale(x, mean = 5.142, sd = 3.999), bscale(x, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(x, mean = 5.142, sd = 3.999, na.rm = FALSE), bscale(x, mean = 5.142, sd = 3.999))
  expect_equal(fscale(xNA, mean = 5.142, sd = 3.999, na.rm = FALSE), bscale(xNA, mean = 5.142, sd = 3.999))
  expect_equal(fscale(xNA, mean = 5.142, sd = 3.999), bscale(xNA, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(qM(fscale(mtcars, mean = 5.142, sd = 3.999)), fscale(m, mean = 5.142, sd = 3.999))
  expect_equal(fscale(m, mean = 5.142, sd = 3.999), dapply(m, bscale, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(m, mean = 5.142, sd = 3.999, na.rm = FALSE), dapply(m, bscale, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mNA, mean = 5.142, sd = 3.999, na.rm = FALSE), dapply(mNA, bscale, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mNA, mean = 5.142, sd = 3.999), dapply(mNA, bscale, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(x, f, mean = 5.142, sd = 3.999), BY(x, f, bscale, na.rm = TRUE, use.g.names = FALSE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(x, f, mean = 5.142, sd = 3.999, na.rm = FALSE), BY(x, f, bscale, use.g.names = FALSE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(xNA, f, mean = 5.142, sd = 3.999, na.rm = FALSE), BY(xNA, f, bscale, use.g.names = FALSE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(xNA, f, mean = 5.142, sd = 3.999), BY(xNA, f, bscale, na.rm = TRUE, use.g.names = FALSE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(m, g, mean = 5.142, sd = 3.999), BY(m, g, bscale, na.rm = TRUE, use.g.names = FALSE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(m, g, mean = 5.142, sd = 3.999, na.rm = FALSE), BY(m, g, bscale, use.g.names = FALSE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mNA, g, mean = 5.142, sd = 3.999, na.rm = FALSE), BY(mNA, g, bscale, use.g.names = FALSE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mNA, g, mean = 5.142, sd = 3.999), BY(mNA, g, bscale, na.rm = TRUE, use.g.names = FALSE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcars, g, mean = 5.142, sd = 3.999), BY(mtcars, g, bscale, na.rm = TRUE, use.g.names = FALSE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcars, g, mean = 5.142, sd = 3.999, na.rm = FALSE), BY(mtcars, g, bscale, use.g.names = FALSE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcNA, g, mean = 5.142, sd = 3.999, na.rm = FALSE), BY(mtcNA, g, bscale, use.g.names = FALSE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcNA, g, mean = 5.142, sd = 3.999), BY(mtcNA, g, bscale, na.rm = TRUE, use.g.names = FALSE, mean = 5.142, sd = 3.999))
})

test_that("Unweighted customized scaling special cases perform as intended ", {
  # No mean / centering
  expect_equal(fscale(x, mean = FALSE, sd = 3.999), bscale(x, na.rm = TRUE, mean = fmean(x), sd = 3.999))
  expect_equal(fscale(x, mean = FALSE, sd = 3.999, na.rm = FALSE), bscale(x, mean = fmean(x), sd = 3.999))
  expect_equal(fscale(xNA, mean = FALSE, sd = 3.999, na.rm = FALSE), bscale(xNA, mean = fmean(xNA), sd = 3.999))
  expect_equal(fscale(xNA, mean = FALSE, sd = 3.999), bscale(xNA, na.rm = TRUE, mean = fmean(xNA), sd = 3.999))
  expect_equal(qM(fscale(mtcars, mean = FALSE, sd = 3.999)), fscale(m, mean = FALSE, sd = 3.999))
  expect_equal(fmean(fscale(mtcars, mean = FALSE, sd = 3.999)), fmean(mtcars))
  expect_equal(unname(fsd(fscale(mtcars, mean = FALSE, sd = 3.999))), rep(3.999, length(mtcars)))
...
test_that("fscale with weights performs like wbscale (defined above)", {
  ...
  expect_equal(fscale(xNA, f, wNA), wBY(xNA, f, wbscale, wNA, na.rm = TRUE))
...
test_that("Weighted customized scaling works as intended", {
  expect_equal(wsu(fscale(x, w = w, mean = 5.142, sd = 3.999), w = w), c(5.142, 3.999))
  expect_equal(wsu(fscale(x, w = w, mean = 5.142, sd = 3.999, na.rm = FALSE), w = w), c(5.142, 3.999))
  expect_equal(wsu(fscale(xNA, w = w, mean = 5.142, sd = 3.999, na.rm = FALSE), w = w), c(NaN, NA))
  expect_equal(wsu(fscale(xNA, w = w, mean = 5.142, sd = 3.999), w = w), c(5.142, 3.999), w = w)
  expect_equal(qM(fscale(mtcars, w = wdat, mean = 5.142, sd = 3.999)), fscale(m, w = wdat, mean = 5.142, sd = 3.999))
  expect_equal(wsu(fscale(m, w = wdat, mean = 5.142, sd = 3.999), w = wdat), rep(c(5.142, 3.999), c(11, 11)))
  expect_equal(wsu(fscale(m, w = wdat, mean = 5.142, sd = 3.999, na.rm = FALSE), w = wdat), rep(c(5.142, 3.999), c(11, 11)))
  expect_equal(wsu(fscale(mNA, w = wdat, mean = 5.142, sd = 3.999, na.rm = FALSE), w = wdat), rep(c(5.142, 3.999), c(11, 11))+miss)
  expect_equal(wsu(fscale(mNA, w = wdat, mean = 5.142, sd = 3.999), w = wdat), rep(c(5.142, 3.999), c(11, 11)))
  expect_equal(wsuby(fscale(x, f, w = w, mean = 5.142, sd = 3.999), f, w = w), rep(c(5.142, 3.999), rep(fnlevels(f), 2)))
  expect_equal(wsuby(fscale(x, f, w = w, mean = 5.142, sd = 3.999, na.rm = FALSE), f, w = w), rep(c(5.142, 3.999), rep(fnlevels(f), 2)))
  expect_equal(wsuby(fscale(xNA, f, w = w, mean = 5.142, sd = 3.999), f, w = w), rep(c(5.142, 3.999), rep(fnlevels(f), 2)))

  expect_equal(wsu(fscale(x, w = w, mean = FALSE, sd = 3.999), w = w), c(fmean(x, w = w), 3.999))
  expect_equal(wsu(fscale(x, w = w, mean = FALSE, sd = 3.999, na.rm = FALSE), w = w), c(fmean(x, w = w), 3.999))
  expect_equal(wsu(fscale(xNA, w = w, mean = FALSE, sd = 3.999, na.rm = FALSE), w = w), c(NaN, NA))
  expect_equal(wsu(fscale(xNA, w = w, mean = FALSE, sd = 3.999), w = w), c(fmean(xNA, w = w), 3.999))
  expect_equal(qM(fscale(mtcars, w = wdat, mean = FALSE, sd = 3.999)), fscale(m, w = wdat, mean = FALSE, sd = 3.999))

  # ...
  # expect_equal(wsuby(fscale(x, f, w = w, mean = "overall.mean", sd = 3.999), f, w = w), rep(c(5.142, 3.999), rep(fnlevels(f), 2)))
  # expect_equal(wsuby(fscale(x, f, w = w, mean = FALSE, sd = 3.999, na.rm = FALSE), f, w = w), rep(c(5.142, 3.999), rep(fnlevels(f), 2)))
  # expect_equal(wsuby(fscale(xNA, f, w = w, mean = FALSE, sd = 3.999), f, w = w), rep(c(5.142, 3.999), rep(fnlevels(f), 2)))

})

test_that("Weighted customized scaling performs like wbscale (defined above)", {
  # complete weights
  expect_equal(fscale(NA, w = 1, mean = 5.142, sd = 3.999), wbscale(NA, 1, mean = 5.142, sd = 3.999))
  expect_equal(fscale(NA, w = 1, na.rm = FALSE, mean = 5.142, sd = 3.999), wbscale(NA, 1, mean = 5.142, sd = 3.999))
  expect_equal(fscale(1, w = 1, mean = 5.142, sd = 3.999), wbscale(1, w = 1, mean = 5.142, sd = 3.999))
  expect_equal(fscale(1:3, w = 1:3, mean = 5.142, sd = 3.999), wbscale(1:3, 1:3, mean = 5.142, sd = 3.999))
  expect_equal(fscale(-1:1, w = 1:3, mean = 5.142, sd = 3.999), wbscale(-1:1, 1:3, mean = 5.142, sd = 3.999))
  expect_equal(fscale(1, w = 1, na.rm = FALSE, mean = 5.142, sd = 3.999), wbscale(1, 1, mean = 5.142, sd = 3.999))
  expect_equal(fscale(1:3, w = c(0.99,3454,1.111), na.rm = FALSE, mean = 5.142, sd = 3.999), wbscale(1:3, c(0.99,3454,1.111), mean = 5.142, sd = 3.999))
  expect_equal(fscale(-1:1, w = 1:3, na.rm = FALSE, mean = 5.142, sd = 3.999), wbscale(-1:1, 1:3, mean = 5.142, sd = 3.999))
  expect_equal(fscale(x, w = w, mean = 5.142, sd = 3.999), wbscale(x, w, mean = 5.142, sd = 3.999))
  expect_equal(fscale(x, w = w, na.rm = FALSE, mean = 5.142, sd = 3.999), wbscale(x, w, mean = 5.142, sd = 3.999))
  expect_equal(fscale(xNA, w = w, na.rm = FALSE, mean = 5.142, sd = 3.999), wbscale(xNA, w, mean = 5.142, sd = 3.999))
  expect_equal(fscale(xNA, w = w, mean = 5.142, sd = 3.999), wbscale(xNA, w, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(qM(fscale(mtcars, w = wdat, mean = 5.142, sd = 3.999)), fscale(m, w = wdat, mean = 5.142, sd = 3.999))
  expect_equal(fscale(m, w = wdat, mean = 5.142, sd = 3.999), dapply(m, wbscale, wdat, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(m, w = wdat, na.rm = FALSE, mean = 5.142, sd = 3.999), dapply(m, wbscale, wdat, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mNA, w = wdat, na.rm = FALSE, mean = 5.142, sd = 3.999), dapply(mNA, wbscale, wdat, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mNA, w = wdat, mean = 5.142, sd = 3.999), dapply(mNA, wbscale, wdat, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcars, w = wdat, mean = 5.142, sd = 3.999), dapply(mtcars, wbscale, wdat, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcars, w = wdat, na.rm = FALSE, mean = 5.142, sd = 3.999), dapply(mtcars, wbscale, wdat, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcNA, w = wdat, na.rm = FALSE, mean = 5.142, sd = 3.999), dapply(mtcNA, wbscale, wdat, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcNA, w = wdat, mean = 5.142, sd = 3.999), dapply(mtcNA, wbscale, wdat, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(x, f, w, mean = 5.142, sd = 3.999), wBY(x, f, wbscale, w, mean = 5.142, sd = 3.999))
  expect_equal(fscale(x, f, w, na.rm = FALSE, mean = 5.142, sd = 3.999), wBY(x, f, wbscale, w, mean = 5.142, sd = 3.999))
  expect_equal(fscale(xNA, f, w, na.rm = FALSE, mean = 5.142, sd = 3.999), wBY(xNA, f, wbscale, w, mean = 5.142, sd = 3.999))
  expect_equal(fscale(xNA, f, w, mean = 5.142, sd = 3.999), wBY(xNA, f, wbscale, w, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(m, g, wdat, mean = 5.142, sd = 3.999), wBY(m, g, wbscale, wdat, mean = 5.142, sd = 3.999))
  expect_equal(fscale(m, g, wdat, na.rm = FALSE, mean = 5.142, sd = 3.999), wBY(m, g, wbscale, wdat, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mNA, g, wdat, na.rm = FALSE, mean = 5.142, sd = 3.999),  wBY(mNA, g, wbscale, wdat, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mNA, g, wdat, mean = 5.142, sd = 3.999), wBY(mNA, g, wbscale, wdat, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcars, g, wdat, mean = 5.142, sd = 3.999), wBY(mtcars, g, wbscale, wdat, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcars, g, wdat, na.rm = FALSE, mean = 5.142, sd = 3.999), wBY(mtcars, g, wbscale, wdat, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcNA, g, wdat, na.rm = FALSE, mean = 5.142, sd = 3.999), wBY(mtcNA, g, wbscale, wdat, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcNA, g, wdat, mean = 5.142, sd = 3.999), wBY(mtcNA, g, wbscale, wdat, na.rm = TRUE, mean = 5.142, sd = 3.999))
  # missing weights
  expect_equal(fscale(NA, w = NA, mean = 5.142, sd = 3.999), wbscale(NA, NA, mean = 5.142, sd = 3.999))
  expect_equal(fscale(NA, w = NA, na.rm = FALSE, mean = 5.142, sd = 3.999), wbscale(NA, NA, mean = 5.142, sd = 3.999))
  expect_equal(fscale(1, w = NA, mean = 5.142, sd = 3.999), wbscale(1, w = NA, mean = 5.142, sd = 3.999))
  expect_equal(fscale(1:3, w = c(NA,1:2), mean = 5.142, sd = 3.999), wbscale(1:3, c(NA,1:2), na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(-1:1, w = c(NA,1:2), mean = 5.142, sd = 3.999), wbscale(-1:1, c(NA,1:2), na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(1, w = NA, na.rm = FALSE, mean = 5.142, sd = 3.999), wbscale(1, NA, mean = 5.142, sd = 3.999))
  expect_equal(fscale(1:3, w = c(NA,1:2), na.rm = FALSE, mean = 5.142, sd = 3.999), wbscale(1:3, c(NA,1:2), mean = 5.142, sd = 3.999))
  expect_equal(fscale(-1:1, w = c(NA,1:2), na.rm = FALSE, mean = 5.142, sd = 3.999), wbscale(-1:1, c(NA,1:2), mean = 5.142, sd = 3.999))
  expect_equal(fscale(x, w = wNA, mean = 5.142, sd = 3.999), wbscale(x, wNA, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(x, w = wNA, na.rm = FALSE, mean = 5.142, sd = 3.999), wbscale(x, wNA, mean = 5.142, sd = 3.999))
  expect_equal(fscale(xNA, w = wNA, na.rm = FALSE, mean = 5.142, sd = 3.999), wbscale(xNA, wNA, mean = 5.142, sd = 3.999))
  expect_equal(fscale(xNA, w = wNA, mean = 5.142, sd = 3.999), wbscale(xNA, wNA, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(qM(fscale(mtcars, w = wdatNA, mean = 5.142, sd = 3.999)), fscale(m, w = wdatNA, mean = 5.142, sd = 3.999))
  expect_equal(fscale(m, w = wdatNA, mean = 5.142, sd = 3.999), dapply(m, wbscale, wdatNA, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(m, w = wdatNA, na.rm = FALSE, mean = 5.142, sd = 3.999), dapply(m, wbscale, wdatNA, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mNA, w = wdatNA, na.rm = FALSE, mean = 5.142, sd = 3.999), dapply(mNA, wbscale, wdatNA, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mNA, w = wdatNA, mean = 5.142, sd = 3.999), dapply(mNA, wbscale, wdatNA, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcars, w = wdatNA, mean = 5.142, sd = 3.999), dapply(mtcars, wbscale, wdatNA, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcars, w = wdatNA, na.rm = FALSE, mean = 5.142, sd = 3.999), dapply(mtcars, wbscale, wdatNA, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcNA, w = wdatNA, na.rm = FALSE, mean = 5.142, sd = 3.999), dapply(mtcNA, wbscale, wdatNA, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcNA, w = wdatNA, mean = 5.142, sd = 3.999), dapply(mtcNA, wbscale, wdatNA, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(x, f, wNA, mean = 5.142, sd = 3.999), wBY(x, f, wbscale, wNA, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(x, f, wNA, na.rm = FALSE, mean = 5.142, sd = 3.999), wBY(x, f, wbscale, wNA, mean = 5.142, sd = 3.999))
  expect_equal(fscale(xNA, f, wNA, na.rm = FALSE, mean = 5.142, sd = 3.999), wBY(xNA, f, wbscale, wNA, mean = 5.142, sd = 3.999))
  expect_equal(fscale(xNA, f, wNA, mean = 5.142, sd = 3.999), wBY(xNA, f, wbscale, wNA, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(replace_Inf(fscale(m, g, wdatNA, mean = 5.142, sd = 3.999), NA), wBY(m, g, wbscale, wdatNA, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(m, g, wdatNA, na.rm = FALSE, mean = 5.142, sd = 3.999), wBY(m, g, wbscale, wdatNA, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mNA, g, wdatNA, na.rm = FALSE, mean = 5.142, sd = 3.999),  wBY(mNA, g, wbscale, wdatNA, mean = 5.142, sd = 3.999))
  expect_equal(replace_Inf(fscale(mNA, g, wdatNA, mean = 5.142, sd = 3.999), NA), wBY(mNA, g, wbscale, wdatNA, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(replace_Inf(fscale(mtcars, g, wdatNA, mean = 5.142, sd = 3.999), NA), wBY(mtcars, g, wbscale, wdatNA, na.rm = TRUE, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcars, g, wdatNA, na.rm = FALSE, mean = 5.142, sd = 3.999), wBY(mtcars, g, wbscale, wdatNA, mean = 5.142, sd = 3.999))
  expect_equal(fscale(mtcNA, g, wdatNA, na.rm = FALSE, mean = 5.142, sd = 3.999), wBY(mtcNA, g, wbscale, wdatNA, mean = 5.142, sd = 3.999))
  expect_equal(replace_Inf(fscale(mtcNA, g, wdatNA, mean = 5.142, sd = 3.999), NA), wBY(mtcNA, g, wbscale, wdatNA, na.rm = TRUE, mean = 5.142, sd = 3.999))
})
...
test_that("Weighted customized scaling special cases perform as intended ", {
  ...
  # No mean / centering
  expect_equal(fscale(x, w = w, mean = FALSE, sd = 3.999), wbscale(x, na.rm = TRUE, w = w, mean = fmean(x, w = w), sd = 3.999))
  expect_equal(fscale(x, w = w, mean = FALSE, sd = 3.999, na.rm = FALSE), wbscale(x, w = w, mean = fmean(x, w = w), sd = 3.999))
  expect_equal(fscale(xNA, w = w, mean = FALSE, sd = 3.999, na.rm = FALSE), wbscale(xNA, w = w, mean = fmean(xNA, w = w), sd = 3.999))
  expect_equal(fscale(xNA, w = w, mean = FALSE, sd = 3.999), wbscale(xNA, na.rm = TRUE, w = w, mean = fmean(xNA, w = w), sd = 3.999))
  expect_equal(qM(fscale(mtcars, w = wdat, mean = FALSE, sd = 3.999)), fscale(m, w = wdat, mean = FALSE, sd = 3.999))
  expect_equal(fmean(fscale(mtcars, w = wdat, mean = FALSE, sd = 3.999), w = wdat), fmean(mtcars, w = wdat))
  expect_equal(unname(fsd(fscale(mtcars, w = wdat, mean = FALSE, sd = 3.999), w = wdat)), rep(3.999, length(mtcars)))
...
test_that("fscale customized scaling performs numerically stable", {
  expect_true(all_obj_equal(replicate(50, fscale(1, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(NA, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(NA, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(x, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(x, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(xNA, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(xNA, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(m, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(m, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mNA, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mNA, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcars, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcars, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcNA, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcNA, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(x, f, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(x, f, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(xNA, f, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(xNA, f, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(m, g, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(m, g, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mNA, g, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mNA, g, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcars, g, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcars, g, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcNA, g, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcNA, g, mean = 5.142, sd = 3.999), simplify = FALSE)))
})
...
test_that("fscale customized scaling with complete weights performs numerically stable", {
  expect_true(all_obj_equal(replicate(50, fscale(1, w = 1, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(NA, w = 1, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(NA, w = 1, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(x, w = w, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(x, w = w, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(xNA, w = w, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(xNA, w = w, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(m, w = wdat, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(m, w = wdat, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mNA, w = wdat, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mNA, w = wdat, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcars, w = wdat, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcars, w = wdat, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcNA, w = wdat, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcNA, w = wdat, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(x, f, w, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(x, f, w, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(xNA, f, w, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(xNA, f, w, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(m, g, wdat, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(m, g, wdat, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mNA, g, wdat, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mNA, g, wdat, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcars, g, wdat, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcars, g, wdat, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcNA, g, wdat, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcNA, g, wdat, mean = 5.142, sd = 3.999), simplify = FALSE)))
})
...
test_that("fscale customized scaling with missing weights performs numerically stable", {
  expect_true(all_obj_equal(replicate(50, fscale(1, w = NA, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(NA, w = NA, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(NA, w = NA, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(x, w = wNA, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(x, w = wNA, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(xNA, w = wNA, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(xNA, w = wNA, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(m, w = wdatNA, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(m, w = wdatNA, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mNA, w = wdatNA, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mNA, w = wdatNA, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcars, w = wdatNA, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcars, w = wdatNA, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcNA, w = wdatNA, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcNA, w = wdatNA, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(x, f, wNA, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(x, f, wNA, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(xNA, f, wNA, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(xNA, f, wNA, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(m, g, wdatNA, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(m, g, wdatNA, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mNA, g, wdatNA, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mNA, g, wdatNA, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcars, g, wdatNA, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcars, g, wdatNA, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcNA, g, wdatNA, na.rm = FALSE, mean = 5.142, sd = 3.999), simplify = FALSE)))
  expect_true(all_obj_equal(replicate(50, fscale(mtcNA, g, wdatNA, mean = 5.142, sd = 3.999), simplify = FALSE)))
})
