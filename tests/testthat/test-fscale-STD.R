...
test_that("Weighted customized scaling performs like wbscale (defined above)", {
  ...
  expect_equal(fscale(x, f, w, mean = 5.142, sd = 3.999), unlist(Map(function(x,y) wbscale(x,y, mean = 5.142, sd = 3.999, na.rm = TRUE), split(x, f), split(w, f)), use.names = FALSE))
  expect_equal(fscale(x, f, w, na.rm = FALSE, mean = 5.142, sd = 3.999), unlist(Map(function(x,y) wbscale(x,y, mean = 5.142, sd = 3.999), split(x, f), split(w, f)), use.names = FALSE))
  expect_equal(fscale(xNA, f, w, na.rm = FALSE, mean = 5.142, sd = 3.999), unlist(Map(function(x,y) wbscale(x,y, mean = 5.142, sd = 3.999), split(xNA, f), split(w, f)), use.names = FALSE))
  expect_equal(fscale(xNA, f, w, mean = 5.142, sd = 3.999), unlist(Map(function(x,y) wbscale(x,y, mean = 5.142, sd = 3.999, na.rm = TRUE), split(xNA, f), split(w, f)), use.names = FALSE))
  # missing weights
  ...
  expect_equal(fscale(x, f, wNA, mean = 5.142, sd = 3.999), unlist(Map(function(x,y) wbscale(x,y, mean = 5.142, sd = 3.999, na.rm = TRUE), split(x, f), split(wNA, f)), use.names = FALSE))
  expect_equal(fscale(x, f, wNA, na.rm = FALSE, mean = 5.142, sd = 3.999), unlist(Map(function(x,y) wbscale(x,y, mean = 5.142, sd = 3.999), split(x, f), split(wNA, f)), use.names = FALSE))
  expect_equal(fscale(xNA, f, wNA, na.rm = FALSE, mean = 5.142, sd = 3.999), unlist(Map(function(x,y) wbscale(x,y, mean = 5.142, sd = 3.999), split(xNA, f), split(wNA, f)), use.names = FALSE))
  expect_equal(fscale(xNA, f, wNA, mean = 5.142, sd = 3.999), unlist(Map(function(x,y) wbscale(x,y, mean = 5.142, sd = 3.999, na.rm = TRUE), split(xNA, f), split(wNA, f)), use.names = FALSE))
})
