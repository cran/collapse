...
.COLLAPSE_ALL <- sort(unique(c("%!in%", "add_stub", "add_vars", "add_vars<-", "all_identical", "all_obj_equal", "as.character_factor", "as.factor_GRP", "as.factor_qG", "as.numeric_factor", "atomic_elem", "atomic_elem<-", "av", "av<-", "B", "BY", "cat_vars", "cat_vars<-", "char_vars", "char_vars<-", "cinv", "ckmatch", "collap", "collapg", "collapv", "colorder", "colorderv", "copyAttrib", "copyMostAttrib", "D", "dapply", "Date_vars", "Date_vars<-", "descr", "Dlog", "F", "fact_vars", "fact_vars<-", "fbetween", "fcompute", "fdiff", "fdim", "fdroplevels", "fdroplevels.factor", "ffirst", "fFtest", "fgroup_by", "fgroup_vars", "fgrowth", "fHDbetween", "fHDwithin", "finteraction", "flag", "flast", "flm", "fmax", "fmean", "fmedian", "fmin", "fmode", "fncol", "fNdistinct", "fnlevels", "fNobs", "fnrow", "fnth", "fprod", "frename", "fscale", "fsd", "fselect", "fselect<-", "fsubset", "fsum", "ftransform", "ftransform<-", "ftransformv", "fungroup", "funique", "fvar", "fwithin", "G", "gby", "get_elem", "get_vars", "get_vars<-", "GGDC10S", "groupid", "GRP", "GRPnames", "gv", "gv<-", "gvr", "gvr<-", "has_elem", "HDB", "HDW", "irreg_elem", "is.categorical", "is.Date", "is.GRP", "is.qG", "is.regular", "is.unlistable", "L", "ldepth", "list_elem", "list_elem<-", "logi_vars", "logi_vars<-", "mctl", "mrtl", "na_insert", "na_omit", "na_rm", "namlab", "num_vars", "num_vars<-", "nv", "nv<-", "print.pwcor", "print.pwcov", "print.qsu", "psacf", "psccf", "psmat", "pspacf", "pwcor", "pwcov", "pwNobs", "qDF", "qDT", "qF", "qG", "qM", "qsu", "qTBL", "radixorder", "radixorderv", "rapply2d", "Recode", "recode_char", "recode_num", "reg_elem", "replace_Inf", "replace_NA", "replace_non_finite", "replace_outliers", "rm_stub", "roworder", "roworderv", "rsplit", "sbt", "seq_col", "seq_row", "seqid", "setAttrib", "setColnames", "setDimnames", "setrename", "setRownames", "settfm", "settfmv", "settransform", "settransformv", "slt", "slt<-", "ss", "STD", "tfm", "tfm<-", "tfmv", "TRA", "unattrib", "unlist2d", "varying", "vclasses", "vlabels", "vlabels<-", "vtypes", "W", "wlddev")))
