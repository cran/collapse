...
.COLLAPSE_ALL <- sort(unique(c("%-=%", "%!=%", "%!in%", "%*=%", "%/=%", "%+=%", "%=%", "%==%", "%c-%", "%c*%",
                               ...
                               "add_vars", "add_vars<-", "all_identical", "all_obj_equal", "alloc", "allv",
                               "anyv", "as_character_factor", "as_factor_GRP", "as_factor_qG", "as_numeric_factor",
                               "atomic_elem", "atomic_elem<-", "av", "av<-", "B", "BY", "cat_vars", "cat_vars<-",
                               "char_vars", "char_vars<-", "cinv", "ckmatch", "collap", "collapg", "collapv",
                               "colorder", "colorderv", "copyAttrib", "copyMostAttrib", "copyv", "D", "dapply",
                               "date_vars", "Date_vars", "date_vars<-", "Date_vars<-", "descr", "Dlog", "F",
                               "fact_vars", "fact_vars<-", "fbetween", "fcompute", "fcomputev", "fcumsum",
                               "fdiff", "fdim", "fdroplevels", "ffirst", "fFtest", "fgroup_by", "fgroup_vars",
                               "fgrowth", "fhdbetween", "fhdwithin", "finteraction", "flag", "flast", "flm",
                               "fmax", "fmean", "fmedian", "fmin", "fmode", "fmutate", "fncol", "fndistinct",
                               "fnlevels", "fnobs", "fnrow", "fnth", "fprod", "frename", "fscale", "fsd",
                               "fselect", "fselect<-", "fsubset", "fsum", "fsummarise", "ftransform", "ftransform<-",
                               "ftransformv", "fungroup", "funique", "fvar", "fwithin", "G", "gby", "get_elem",
                               "get_vars", "get_vars<-", "GGDC10S", "group", "groupid", "GRP", "GRPnames", "gsplit",
                               "gv", "gv<-", "gvr", "gvr<-", "has_elem", "irreg_elem", "is_categorical", "is_date",
                               "is_GRP", "is_qG", "is_unlistable", "L", "ldepth", "list_elem", "list_elem<-",
                               "logi_vars", "logi_vars<-", "massign", "mctl", "missing_cases", "mrtl", "mtt",
                               "na_insert", "na_omit", "na_rm", "namlab", "num_vars", "num_vars<-", "nv", "nv<-",
                               "pad", "psacf", "psccf", "psmat", "pspacf", "pwcor", "pwcov", "pwnobs", "qDF", "qDT",
                               "qF", "qG", "qM", "qsu", "qTBL", "radixorder", "radixorderv", "rapply2d", "Recode",
                               "recode_char", "recode_num", "reg_elem", "relabel", "replace_Inf", "replace_non_finite",
                               "replace_outliers", "rm_stub", "rnm", "roworder", "roworderv", "rsplit", "sbt", "seq_col",
                               "seq_row", "seqid", "setAttrib", "setColnames", "setDimnames", "setLabels", "setop",
                               "setrelabel", "setrename", "setRownames", "settfm", "settfmv", "settransform",
                               "settransformv", "setv", "slt", "slt<-", "smr", "ss", "STD", "t_list", "tfm", "tfm<-",
                               "tfmv", "TRA", "unattrib", "unlist2d", "varying", "vclasses", "vlabels", "vlabels<-",
                               "vlengths", "vtypes", "W", "whichv", "wlddev", "HDB", "HDW", "allNA", "whichNA")))
